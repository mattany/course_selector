...
and the assignments of the student to courses, and : EVALUATE the student's satisfaction level.
...
def borda_count_evaluation(pre_assignment_preferences, post_assignment_results):
    ...
    Example:
    if each student evaluates 10 courses : c1, c2, ..., c10
    and the student got courses 1, 3, 8
    the student satisfaction measurement for each courses is : 10, 8, 3
...
def investment_evaluation(pre_assignment_preferences, post_assignment_results):
    ...
    Example:
    if each student evaluates 10 courses : c1, c2, ..., c10
    and the student got courses 1, 3, 8 with ranks 60, 17, 2 (he had a total of 100 to distribute)
